      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-black text-gray-900 uppercase tracking-tight">
            Site <span className="text-amber-600">Settings</span>
          </h1>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full max-w-sm border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-amber-500"
              />
            </div>
