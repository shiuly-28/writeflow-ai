        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b ${
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className={`flex items-center gap-2 text-lg font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r ${
              isDarkMode ? "from-amber-400 to-amber-500" : "from-amber-600 to-amber-600"
            }`}>
              <Sparkles className={`h-5 w-5 ${isDarkMode ? "text-amber-400" : "text-amber-600"}`} />
              WriteFlow AI
            </Link>
            ...
            <div className="flex gap-4 mt-2">
              <a href="#" className={`transition-colors ${isDarkMode ? "text-slate-500 hover:text-white" : "text-slate-400 hover:text-amber-600"}`} aria-label="GitHub">
              ...
              <a href="#" className={`transition-colors ${isDarkMode ? "text-slate-500 hover:text-white" : "text-slate-400 hover:text-amber-600"}`} aria-label="Twitter">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" className={`transition-colors ${isDarkMode ? "text-slate-500 hover:text-white" : "text-slate-400 hover:text-amber-600"}`} aria-label="LinkedIn">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative w-full">
                <input
                  ...
                  className={`w-full rounded-lg border px-3.5 py-2.5 text-sm focus:outline-none transition-all ${
                    isDarkMode 
                      ? "bg-slate-900 border-white/10 text-white placeholder-slate-500 focus:border-amber-500" 
